...
$(document).ready(function(){
            ...
            <ul class="items-center text-white font-medium text-2xl uppercase flex-wrap *:leading-10 *:p-4 hidden md:flex *:transition-all *:duration-500">
              ...
              <li class="group relative hover:bg-[#3498db]">
                <a href="huong-dan-ca-cuoc.html" class="flex items-center">
                  ...
                  <div>
                    <svg class="inline-block w-8 h-8 text-white transition-all duration-300 group-hover:rotate-180"
                ...
                <div
                  class="duration-500 opacity-0 z-10 invisible group-hover:visible group-hover:opacity-[1] group-hover:top-[4.97rem] rounded bg-white divide-y divide-gray-100 shadow absolute w-[30rem] left-0 top-[6.97rem]">
                  <ul class="px-5 text-xl text-gray-500  *:py-4 *:border-b">
                    <li class="hover:text-gray-700"> <a onclick="url()" class="transition-all cursor-pointer">Sản
                        Phẩm</a> </li>
                    <li class=" hover:text-gray-900"> <a onclick="url()" class="transition-all cursor-pointer"> Thủ
                        Thuật</a> </li>
                    <li class=" hover:text-gray-900"> <a onclick="url()" class="transition-all cursor-pointer"> Soi
                        Kèo</a> </li>
                  </ul>
                </div>
              </li>
        ...
        <div class="container mx-auto">
          <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 lg:gap-7">
            <div class="py-5 lg:py-10 *:pb-5">
              ...
              <p class="text-white">W88s website nhà cái W88 chính thức tại Việt Nam, cung cấp sản phẩm cá cược thể
                thao, casino,… hàng đầu Châu Á. Đăng nhập W88 ngay nhận 90K cược miễn phí</p>
              <hr class="border-white border-t-[1px]">
              <p class="text-white text-[1.4rem]">Hashtag: #w88 #w88s #w88s #linkw88 #nhà_cái_w88 #w88_link #w88s,
                #w88sale</p>
            </div>
            <div class="py-5 lg:py-10 *:pb-5">
              <h1 class="text-3xl font-bold text-white">CÁC SẢN PHẨM</h1>
              <hr class="border-white border-t-[1px]">
              <p class="text-white hover:text-[rgb(255,_136,_0)] duration-300"><a href="dang-ky-w88.html">Đăng Ký W88</a></p>
              <p class="text-white hover:text-[rgb(255,_136,_0)] duration-300"><a href="khuyen-mai-w88.html">Khuyến Mãi W88</a>
              </p>
              <p class="text-white hover:text-[rgb(255,_136,_0)] duration-300"><a href="nap-tien-w88.html">Nạp Tiền W88</a>
              </p>
            ...
            <div class="py-5 lg:py-10 *:pb-5">
              ...
              <hr class="border-white border-t-[1px]">
              <p class="text-white hover:text-[rgb(255,_136,_0)] duration-300"><a href="">Twitter</a></p>
              <p class="text-white hover:text-[rgb(255,_136,_0)] duration-300"><a href="">Youtube</a></p>
              <p class="text-white hover:text-[rgb(255,_136,_0)] duration-300"><a href="">Pinterest</a>
              </p>
              <p class="text-white hover:text-[rgb(255,_136,_0)] duration-300"><a
                  href="kuyenmai20trieubongdavip.html">Tumblr</a></p>
              <h1 class="text-3xl font-bold text-white">CHÍNH SÁCH</h1>
              <hr class="border-white border-t-[1px]">
            ...
            <div class="py-5 lg:py-10 *:pb-5">
              ...
              <p class="text-white">Địa Chỉ: N06B1 Thành Thái, Cầu Giấy, Hà Nội
              <p>
              <p class="text-white">Email: w88s@gmail.com
              <p>
              <p class="text-white">Website: https://w88s.xyz/
              <p>
      ...
      <ul class="w-[60vw] bg-slate-100 h-screen">
        ...
        <li>
          <button type="button" class="flex items-center w-full px-5 py-5 text-2xl font-semibold text-gray-900  rounded-lg hover:bg-gray-200" >
            <a  href="dangkycmd68.htmlcasino.html"  class="flex-1 ml-3 text-left whitespace-nowrap">HƯỚNG DẪN</a>
            <svg
          ...
          <ul  class=" sub-menu-side-menu-mobile  py-2 space-y-2  *:px-14 *:py-4 *:flex *:items-center *:w-full *:text-2xl *:font-medium *:text-gray-800  *:rounded-lg">
            <li class="hover:bg-gray-200 "><a onclick="url()" class="cursor-pointer">SẢN PHẨM</a></li>
            <li class=" hover:bg-gray-200"><a onclick="url()" class="cursor-pointer">THỦ THUẬT</a></li>
            <li class=" hover:bg-gray-200"><a onclick="url()" class="cursor-pointer">SOI KÈO</a></li>
          </ul>
        </li>
      </ul>
    </div>`;
 ...
 <hr class="border-t-[3px] border-[#33a6dd]">
            ...
            <h4 class="text-2xl font-bold "><img class="align-[-1.5px] inline-flex max-w-[1.5rem]" src="https://s.w.org/images/core/emoji/15.0.3/svg/2b50.svg" alt=""> THÔNG TIN NHÀ CÁI W88</h4>
            ...
            <div class="flex justify-center">
              <button onclick="url()" type="button"
                ...
                <i class="text-3xl font-normal text-white ri-arrow-right-line"></i> LINK VÀO W88
              </button>
            </div>
